...
export const coachesTable = pgTable("coaches", {
  ...
  isProfessionalAthleteVerified: boolean("is_professional_athlete_verified").notNull().default(false),
  isLicensedCoachVerified: boolean("is_licensed_coach_verified").notNull().default(false),
