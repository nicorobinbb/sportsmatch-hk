...
BEGIN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'experience_level') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'trial_price') THEN
    ALTER TABLE coaches ALTER COLUMN trial_price DROP NOT NULL;
    ALTER TABLE coaches ALTER COLUMN trial_price SET DEFAULT 0;
    UPDATE coaches SET trial_price = COALESCE(trial_price, 0) WHERE trial_price IS NULL;
  END IF;

  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'regular_price') THEN
    ALTER TABLE coaches ALTER COLUMN regular_price DROP NOT NULL;
    ALTER TABLE coaches ALTER COLUMN regular_price SET DEFAULT 0;
    UPDATE coaches SET regular_price = COALESCE(regular_price, 0) WHERE regular_price IS NULL;
  END IF;

  -- Arrays used by profile/edit flows
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'age_groups') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'teaching_focus') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'is_professional_athlete_verified') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'is_licensed_coach_verified') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'is_featured') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'is_approved') THEN
  ...
  IF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_name = 'coaches' AND column_name = 'is_rejected') THEN
