...
async function seedCoachData() {
  console.log('Updating coach 54 with comprehensive data...\n');
  ...
  console.log('✓ Successfully updated 劉德華教練!\n');
  console.log('Updated fields:');
  console.log('  ✓ Name (CN/EN)');
  console.log('  ✓ Bio (detailed with bullet points)');
  console.log('  ✓ Location (multiple districts)');
  console.log('  ✓ Experience level');
  console.log('  ✓ Teaching focus (競賽, 興趣)');
  console.log('  ✓ Age groups (3 categories)');
  console.log('  ✓ Contact: WhatsApp, FB, IG, Website, YouTube');
  console.log('  ✓ SCRC number');
  console.log('  ✓ Teaching achievements (6 items)');
  console.log('  ✓ Sports achievements (6 items)');
  ...
  console.log('\nCoach Portal will now display:');
  console.log('  ✓ Profile header with image & stats');
  console.log('  ✓ About coach tab with full bio');
  console.log('  ✓ Teaching achievements section');
  console.log('  ✓ Sports achievements section');
  console.log('  ✓ Qualifications list');
