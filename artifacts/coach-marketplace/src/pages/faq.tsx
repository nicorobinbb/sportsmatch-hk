...
const STUDENT_FAQS: FaqItem[] = [
  {
    q: "使用 SportsMatch 搵教練要收錢嗎？",
    a: "完全免費！學員搜尋教練、查看評價及直接聯絡教練都唔需要支付任何費用俾平台。",
  },
  {
    q: "我點樣知道呢個教練係咪可靠？",
    a: "我哋會要求教練提供專業證書及 SCRC（性罪行查核）。通過審核嘅教練會有「已認證」標章，你亦可以參考真實評分。",
  },
  {
    q: "如果有糾紛，平台會處理嗎？",
...
const COACH_FAQS: FaqItem[] = [
  {
    q: "喺 SportsMatch 開 Profile 要錢嗎？",
    a: "唔使！我哋歡迎所有合資格嘅教練免費註冊同建立個人檔案。",
  },
  {
    q: "既然唔抽佣，平台靠咩營運？",
  ...
  {
    q: "點樣可以令我個 Profile 排名高啲？",
    a: "除咗廣告，你嘅回覆速度、學員評分、資歷完整度都會影響排名。",
  },
];
